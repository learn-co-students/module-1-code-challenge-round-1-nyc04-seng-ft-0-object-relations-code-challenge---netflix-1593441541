...
review1 = Review.new(viewer1, avengers, 5)
review2 = Review.new(viewer1, spiderman, 3)
review3 = Review.new(viewer2, ironman, 4)
review4 = Review.new(viewer2, spideyverse, 5)
review5 = Review.new(viewer3, ironman, 3)
